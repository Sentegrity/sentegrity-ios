...
// Facade
#define COCOAPODS_POD_AVAILABLE_Facade
#define COCOAPODS_VERSION_MAJOR_Facade 0
#define COCOAPODS_VERSION_MINOR_Facade 2
#define COCOAPODS_VERSION_PATCH_Facade 0

// IIDelayedAction
#define COCOAPODS_POD_AVAILABLE_IIDelayedAction
#define COCOAPODS_VERSION_MAJOR_IIDelayedAction 1
#define COCOAPODS_VERSION_MINOR_IIDelayedAction 0
#define COCOAPODS_VERSION_PATCH_IIDelayedAction 1
