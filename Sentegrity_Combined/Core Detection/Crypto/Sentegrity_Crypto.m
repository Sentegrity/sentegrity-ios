...
- (NSData *)decryptMasterKeyUsingVocalFacialkey:(NSData *)userPBKDF2Key withError:(NSError **)error {
    ...
    // Get user-encrypted master key strings from startup file
    NSString *userKeyEncryptedMasterKeyBlobString = [startup vocalFacialKeyEncryptedMasterKeyBlobString];
    NSString *userKeyEncryptedMasterKeySaltString = [startup userKeySaltString];
...
- (BOOL)updateVocalFacialForExistingMasterKeyWithVocalFacialPassword:(NSString *)vocalFacialPassword withDecryptedMasterKey:(NSData *)masterKey withError:(NSError **)error {
    ...
    // Get derived key
    NSData *userKeyData = [self createPBKDF2KeyFromString:vocalFacialPassword withSaltData:userSaltData withRounds:[startup userKeyPBKDF2rounds] withError:&userKeyDataError];
    ...
    // Set user key pbkdf2 hash string
    [startup setVocalFacialIDKeyHash:userKeyPBKDF2HashString];
    ...
    // Store the encrypted key blob
    [startup setVocalFacialKeyEncryptedMasterKeyBlobString:userKeyEncryptedMasterKeyBlobString];
