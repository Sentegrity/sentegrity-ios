...
+ (Sentegrity_TrustFactor_Output_Object *)defaultSSID:(NSArray *)payload {
    ...
    NSString* ssidListPath = [[NSBundle mainBundle] pathForResource:@"default_ssids" ofType:@"list"];
...
+ (Sentegrity_TrustFactor_Output_Object *)hotspot:(NSArray *)payload {
    ...
    // Look for our OUI list
    NSString* ouiListPath = [[NSBundle mainBundle] pathForResource:@"hotspot_ssids" ofType:@"list"];
